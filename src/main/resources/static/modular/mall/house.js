...
layui.define(['element', 'carousel', 'table', 'util'], function(exports){
  ...
  $(".house-header").find("#switch").on('click', function(){
    if(houseNav.hasClass("close")){
      $(".house-header").children(".layui-container")[0].style.height = 80 + houseNav[0].offsetHeight + 'px';
  ...
  table.render({
    ...
    ,text: {
      none: '<div class="house-usershop-table-none"><div><img src="/modular/mall/img/shopnone.png"></div><p>购物车空空如也</p><a class="layui-btn layui-btn-primary" href="list.html">去逛逛</a></div>'
    }
